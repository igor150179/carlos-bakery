...
export function MenuShowcaseBanner() {
  ...
  return (
    <FadeIn>
      <Link
        href="/cardapio"
        className="group relative block overflow-hidden rounded-sm bg-espresso-950 shadow-[0_32px_80px_-40px_rgba(15,11,8,0.65)] ring-1 ring-champagne-on-dark-muted/20 transition-[box-shadow,ring-color] duration-700 hover:shadow-[0_40px_90px_-36px_rgba(15,11,8,0.72)] hover:ring-champagne-on-dark-soft/35"
      >
