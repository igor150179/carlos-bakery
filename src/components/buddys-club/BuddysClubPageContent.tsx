...
export function BuddysClubPageContent() {
  ...
  return (
    <article>
      ...
      <section className="bg-carlo-stripes px-[var(--container-padding-x)] py-16 md:py-20">
        <DarkSectionHeader
      ...
      <section className="bg-carlo-stripes px-[var(--container-padding-x)] py-12 md:py-14">
